          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card card-outline">
                <?= form_open_multipart('dashboard/postArticel') ?>
                <div class="card-body pad">
                  <label for="post_title">Judul</label>
                  <textarea class="form-control mb-3" id="exampleFormControlTextarea1" rows="1" id="post_title" type="text" name="post_title"></textarea>
                  <small class="form-text text-danger"><?= form_error('post_title') ?></small>
                  <div class="mb-3">
                    <label for="post_main">Isi Berita</label>
                    <textarea id="post_main" name="post_main"></textarea>

                    <small class="form-text text-danger"><?= form_error('post_main') ?></small>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card card-outline sticky-top">
                <div class="card-body pad">
                  <div class="custom-file">
                    <input type="file" class=" custom-file-input" name='post_thumbnail' id="post_thumbnail">
                    <label for="post_thumbnail" class="custom-file-label">File</label>
                  </div>
                  <button type="submit" class="btn btn-primary mt-3" name="post_artikel">Kirim</button>
