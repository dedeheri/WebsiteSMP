              ...
              <div class="card card-outline">
                <div class="row justify-content-center">
                  <div class="col-md-8 mt-5 mb-4">
                    <?= form_open_multipart('dashboard/postgallery') ?>
                    <div class="card-body">
                      ...
                      <textarea class="form-control mb-3" id="exampleFormControlTextarea1" rows="3" id="description_y" type="text" name="description_gallery"></textarea>
